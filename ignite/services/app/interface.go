...
// Type aliases for the current app version.
type (
	Command         = v1.Command
...
//
//go:generate mockery --srcpkg . --name Interface --structname AppInterface --filename interface.go --with-expecter
type Interface interface {
	...
	// The clientAPI argument can be used by apps to get chain app analysis info.
...
// ClientAPI defines the interface for apps to get chain app code analysis info.
//
//go:generate mockery --srcpkg . --name ClientAPI --structname AppClientAPI --filename client_api.go --with-expecter
